...
class TeamChatScreen extends ConsumerWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            _buildHorizontalIconButtonSection(),
            Padding(
  ...
  Widget _buildHorizontalIconButtonSection() {
    return Container(
      height: 120.0,
      child: ListView(
        scrollDirection: Axis.horizontal,
        children: <Widget>[
          CupertinoIconButton(icon: CupertinoIcons.star_fill, label: 'Starred'),
          CupertinoIconButton(
          ...
          CupertinoIconButton(icon: CupertinoIcons.news_solid, label: 'Files'),
          CupertinoIconButton(
              icon: CupertinoIcons.alarm_fill, label: 'Reminders'),
          CupertinoIconButton(
              icon: CupertinoIcons.person_add_solid, label: 'Contact R...'),
          CupertinoIconButton(
